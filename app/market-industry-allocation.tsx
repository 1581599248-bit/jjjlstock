...
type MarketIndustryRow = { rank: number; industry: string; industryCode?: string; marketValue: number; allocationShare: number; qoqChange: number | null; fundCount?: number };
